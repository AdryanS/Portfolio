...
const content = [
  {
    ...
    content: [
      ...
      {
        id: 3,
        title: "Detecção Antecipada de Erros",
      },
      {
        id: 4,
      ...
      {
        id: 7,
        title: "Suporte para Novos Recursos JavaScript",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      {
        id: 2,
        title: "Ampla Aceitação de Pagamentos",
      },
      {
        id: 3,
        title: "Segurança",
        ...
        <div className="relative overflow-hidden rounded-lg border bg-background p-2">
          <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                O Tailwind CSS é um framework CSS de código aberto que permite
                criar estilos personalizados para seus projetos
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative overflow-hidden rounded-lg border bg-background p-2">
          <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Um framework progressivo do Node.js para criação de aplicativos
                eficientes, confiáveis e escaláveis no server-side.
              </p>
            </div>
          </div>
        </div>
